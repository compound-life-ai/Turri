    ...
    >
      ...
      <section className="relative z-10 px-6 py-24">
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          <div className="relative rounded-xl border border-white/5 bg-[#13111a] overflow-hidden mb-6">
            <img src="/showcase-nutrition.png" alt="" className="hidden lg:block absolute -right-6 -bottom-6 w-[260px] h-[260px] object-contain pointer-events-none opacity-60" />
            ...
            <div className="relative z-10 px-6 pb-6">
              <p className="text-white text-sm leading-relaxed mb-5 max-w-2xl">
              ...
              <div className="bg-white/[0.03] rounded-lg p-4 text-sm text-gray-300 leading-relaxed border border-white/5 max-w-2xl">
          ...
          <div className="relative rounded-xl border border-white/5 bg-[#13111a] overflow-hidden mb-6">
            <img src="/showcase-patterns.png" alt="" className="hidden lg:block absolute -right-6 -bottom-6 w-[260px] h-[260px] object-contain pointer-events-none opacity-60" />
            <div className="flex items-center gap-2 px-6 pt-5 pb-3">
          ...
          <div className="relative rounded-xl border border-white/5 bg-[#13111a] overflow-hidden">
            <img src="/showcase-integration.png" alt="" className="hidden lg:block absolute -right-6 -bottom-6 w-[260px] h-[260px] object-contain pointer-events-none opacity-60" />
            <div className="flex items-center gap-2 px-6 pt-5 pb-3">
