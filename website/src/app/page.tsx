        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-zinc-500 dark:text-zinc-400 max-w-2xl mx-auto text-lg">
              Four specialized modules designed to bring structure to your longevity journey. Three of these proactively engage you on a daily schedule, replacing passive waiting with active coaching.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            
            {/* Feature 1: /snap (Manual/Interactive) */}
            <div className="flex flex-col group rounded-2xl border border-zinc-200 bg-zinc-50 p-8 transition-all hover:shadow-md dark:border-zinc-800 dark:bg-zinc-950">
              <div className="mb-6 flex justify-between items-start">
                <div className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-orange-100 text-orange-600 dark:bg-orange-900/30 dark:text-orange-400">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z"/>
                    <circle cx="12" cy="13" r="3"/>
                  </svg>
                </div>
                <span className="text-xs font-medium px-2.5 py-1 bg-zinc-200 text-zinc-700 rounded-full dark:bg-zinc-800 dark:text-zinc-300">
                  User-Initiated
                </span>
              </div>
            ...
            {/* Feature 2: /health (Proactive) */}
            <div className="flex flex-col group rounded-2xl border border-zinc-200 bg-zinc-50 p-8 transition-all hover:shadow-md dark:border-zinc-800 dark:bg-zinc-950">
              <div className="mb-6 flex justify-between items-start">
                <div className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-rose-100 text-rose-600 dark:bg-rose-900/30 dark:text-rose-400">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/>
                    <path d="M12 5 9.04 9.53a11.38 11.38 0 0 0-1.98 4.14"/>
                  </svg>
                </div>
                <span className="text-xs font-medium px-2.5 py-1 bg-emerald-100 text-emerald-700 rounded-full dark:bg-emerald-900/30 dark:text-emerald-400 flex items-center">
                  <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 mr-1.5"></span>
                  Proactive Daily Brief
                </span>
              </div>
              <h3 className="text-2xl font-bold mb-3 font-serif">Daily Health Coach</h3>
              <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed mb-6">
                Automated morning briefings summarize your previous day's nutrition, latest Apple Health sleep/activity context, and provide personalized lifestyle coaching without waiting for you to ask.
              </p>
              
              <div className="mt-auto bg-white dark:bg-zinc-900 rounded-xl p-4 border border-zinc-200 dark:border-zinc-800 shadow-sm text-sm space-y-3 font-sans">
                <div className="flex justify-start">
                  <div className="bg-zinc-100 dark:bg-zinc-800 text-zinc-800 dark:text-zinc-200 rounded-2xl rounded-tl-sm px-4 py-3 max-w-[85%]">
                    <p className="font-medium mb-2">☀️ Good morning!</p>
                    <p className="mb-2">Yesterday you hit 1,850 kcal (145g protein) and slept for 7h 15m.</p>
                    <p>Coach tip: Your HRV is up! Let's aim for a heavier training session today since you're well-recovered.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col group rounded-2xl border border-zinc-200 bg-zinc-50 p-8 transition-all hover:shadow-md dark:border-zinc-800 dark:bg-zinc-950">
              ...
              <h3 className="text-2xl font-bold mb-3 font-serif">Curated News Delivery</h3>
              <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed mb-6">
                Automatically fetches and delivers a curated morning digest focused exclusively on health, longevity, nutrition, sleep, and exercise using high-signal predefined sources.
              </p>
              
              <div className="mt-auto bg-white dark:bg-zinc-900 rounded-xl p-4 border border-zinc-200 dark:border-zinc-800 shadow-sm text-sm space-y-3 font-sans">
                <div className="flex justify-start">
                  <div className="bg-zinc-100 dark:bg-zinc-800 text-zinc-800 dark:text-zinc-200 rounded-2xl rounded-tl-sm px-4 py-3 max-w-[85%]">
                    <p className="font-medium mb-2">📰 Morning Longevity Digest</p>
                    <ul className="space-y-2 list-decimal pl-4 mb-2">
                    ...
                    <p className="text-xs opacity-80 mt-2">Would you like a deeper summary on any of these?</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col group rounded-2xl border border-zinc-200 bg-zinc-50 p-8 transition-all hover:shadow-md dark:border-zinc-800 dark:bg-zinc-950">
              ...
              <h3 className="text-2xl font-bold mb-3 font-serif">Experiment Insights</h3>
              <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed mb-6">
                Tracks hypotheses and actively reaches out for daily check-ins. It explicitly refuses to draw conclusions until statistically significant data is collected.
              </p>
              
              <div className="mt-auto bg-white dark:bg-zinc-900 rounded-xl p-4 border border-zinc-200 dark:border-zinc-800 shadow-sm text-sm space-y-3 font-sans">
                <div className="flex justify-start">
                  <div className="bg-zinc-100 dark:bg-zinc-800 text-zinc-800 dark:text-zinc-200 rounded-2xl rounded-tl-sm px-4 py-2 max-w-[85%]">
                    Time for your daily check-in on <b>"Earlier caffeine cutoff"</b>. How was your sleep quality last night (1-10)?
                  </div>
                </div>
                <div className="flex justify-end">
                  <div className="bg-emerald-500 text-white rounded-2xl rounded-tr-sm px-4 py-2 max-w-[85%]">
                ...
                <div className="flex justify-start">
                  <div className="bg-zinc-100 dark:bg-zinc-800 text-zinc-800 dark:text-zinc-200 rounded-2xl rounded-tl-sm px-4 py-2 max-w-[85%]">
                    Logged! We need 3 more days of data before running a reliable gap analysis.
                  </div>
                </div>
              </div>
            </div>
